/**
 * String.format for JavaScript 1.13
 * mstr.se/sffjs
 *  
 * Built: 2017-05-17T17:37:05Z
 *
 ...
 */
/**
 *	this file is changed from the original version
 */
...
(function() {
    ...
    function resolvePath(path, value) {
        ...
        if (hasValue(value)) {
            ...
            match = followingMembers.exec(path)
            while (hasValue(value) && (match)) {
    ...
    // ***** Date Formatting *****
    _Date.prototype.__Format = function(format) {
        var date        = this, 
    ...
    var formattables = [ _Date.prototype, _Number.prototype, _String ];
